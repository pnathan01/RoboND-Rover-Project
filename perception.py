...
def perception_step(Rover):
    ...
    sample_select = color_thresh(warped, rgb_thresh=sample_rgb_threshold)
    ...
    Rover.vision_image[:,:,0] = terrain_select*255
    ...
    Rover.worldmap[y_pix_world, x_pix_world, 1] += 1
    Rover.worldmap[y_spix_world, x_spix_world, 2] += 1
